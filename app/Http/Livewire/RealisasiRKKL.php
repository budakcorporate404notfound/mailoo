...
class RealisasiRKKL extends Component
{

    public $referensi_kode_uraian_kegitan;
    // public $selected_kode_uraian_kegiatan = NULL;
    ...
    public $tempat_pelaksana;
    public $id_kode_uraian_kegiatan;
    public $tanggal_pelaksana_dari;
    public $tanggal_pelaksana_sampai;
    public $nilai_pagu_realisasi;
    ...
    // {
    //     $this->referensi_kode_uraian_kegitan = DB::table('ref_keuangan_uraian_kegiatan')
    ...
    public function mount()
    {
        $this->referensi_kode_uraian_kegitan = ref_keuangan_uraian_kegiatan::where('ref_keuangan_uraian_kegiatan.id_unitbagian', '=', Auth::user()->unit_kerja)->get();
    }
    ...
    public function Store_RealisasiRKKL()
    {
        $validateData =  $this->validate([
            'nomor_surat_tugas' => 'required',
            'tanggal_surat_tugas' => 'required',
            'tempat_pelaksana' => 'nullable',
            'nilai_pagu_realisasi' => 'nullable',
            'id_kode_uraian_kegiatan' => 'required',
        ...
        T_realisasi_rkkl::create($validateData);
        session()->flash('message', 'sukses +1 data realisasi rkkl');
        $this->resetInputFields();
        $this->emit('studentAdded_RealisasiRKKL');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.realisasi-rkkl', compact('data'))
            ->extends('layouts.app');
    }
}