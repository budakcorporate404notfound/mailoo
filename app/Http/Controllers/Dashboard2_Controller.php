    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::eloquent($data)
                ...
                //     if ($request->has('nilai_pagu_realisasi')) {
                //         $query->where('nilai_pagu_realisasi', 'like', "%{$request->get('nilai_pagu_realisasi')}%");
                //     }
        ...
        return view('dashboard2', compact('datas', 'tempats', 'laporans'));
    }
