...
class Rincian_PembuatLaporanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = T_pembuat_laporan::select(
                't_pembuat_laporan.id',
                'ref_unitbagian.name as namabagian',
                't_pembuat_laporan.t_realisasi_rkkl_id',
                't_pembuat_laporan.nama_pelaksana',
                't_pembuat_laporan.no_surat_tugas',
                't_pembuat_laporan.user_penginput_data',
                't_pembuat_laporan.tahun_anggaran',
                't_pembuat_laporan.created_at',
                't_pembuat_laporan.updated_at'
            )

                ->join('ref_unitbagian', 'ref_unitbagian.id', '=', 't_pembuat_laporan.ref_unitbagian_id')
                ...
                ->where('t_pembuat_laporan.ref_unitbagian_id', '=', Auth::user()->unit_kerja)
        ...
        return view('rincian_pembuatlaporan', compact('datas', 'tempats', 'laporans'));
    }
