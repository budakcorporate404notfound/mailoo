        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Rincian Pembuat Laporan</h4>
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input id="bagian" name="bagian" required="" readonly
                                    placeholder="bagian ..." class="form-control">
                                @error('bagian')
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            // scrollX: true,
            ajax: "{{ route('rincianpembuatlaporan.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        $('body').on('click', '.deleteProduct', function() {
            ...
            if (result) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('rincianpembuatlaporan.store') }}" + '/' + product_id,
                    success: function(data) {
                        if (data.success) {
                            $('#response').html(
