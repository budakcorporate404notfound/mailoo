            ...
            <div class="row no-gutters">
                <div class="col-sm-12 align-self-center">
                    <div class="sign-in-from bg-white">
                        ...
                        {{ __('Untuk mendapatkan akses akun grv✦, klik tombol "Gabung grv✦" dipesan masuk email kamu.') }}
                        {{ __('Tapi, Jika kamu belum mendapatkan pesan dari grv✦ yang masuk ke email kamu. Klik tombol dibawah ini') }}
