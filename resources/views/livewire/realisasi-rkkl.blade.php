<div>
    ...
    @include('livewire.tambah-realisasi-rkkl');
    @include('livewire.update-realisasi-rkkl');
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                                ...
                                <div class="col-md-8">
                                    <h3>
                                        ...
                                        <button type="button" class="btn btn-secondary  " data-toggle="modal"
                                            data-target="#addStudentsModal_RealisasiRKKL">
                                            <i class="las la-plus" style="font-size: 16px"></i>data
                                        </button>

                                        <a style="color: #6c757d">realisasi RKKL</a>
                                    </h3>
                                </div>
                        ...
                        @livewire('datatable-realisasi-r-k-k-l')
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="delete()" class="btn btn-danger close-modal"
                        data-dismiss="modal">Iya, Hapus </button>
                </div>
            </div>
        </div>
    </div>
