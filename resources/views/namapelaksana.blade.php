...
<nav aria-label="breadcrumb">
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Nama Pelaksana</li>
    </ul>
</nav>
@endsection
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Data Nama Pelaksana</h4>
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input id="nama_pelaksana" name="nama_pelaksana" required=""
                                    placeholder="nama pelaksana ..." class="form-control">
                          ...
                          <div class="form-row">
                            <div class="col">
                                ...
                                <input id="golongan" name="golongan"
                                    placeholder="golongan ..." class="form-control">
                                @error('nama_pelaksana')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input id="jabatan" type="text" name="jabatan"
                                    placeholder="jabatan ..." class="form-control">
                                @error('jabatan')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                                ...
                                <input id="eselon" type="text" name="eselon"
                                    placeholder="eselon ..." class="form-control">
                                @error('eselon')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
                            </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#createNewProduct').click(function() {
            ...
            $('#modelHeading').html("Tambah Nama Pelaksana");
            $('#ajaxModel').modal('show');
        });
        $('body').on('click', '.editProduct', function() {
            var product_id = $(this).data('id');
            $.get("{{ route('namapelaksana.index') }}" + '/' + product_id + '/edit', function(data) {
                ...
                $('#nama_pelaksana').val(data.nama);
                $('#nip').val(data.nip);
                $('#golongan').val(data.gol);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            $('#response').html(
                                '<button type="button" class="btn mb-3 btn-info rounded-pill"><i class="ri-heart-fill"></i> tambah atau edit nama pelaksana berhasil <i class="ri-heart-fill"></i></button>'
                            );
                            ...
                            $('#saveBtn').html('Save Changes');
                            $('#response').html(
                                '<button type="button" class="btn mb-3 btn-danger rounded-pill"><i class="las la-skull-crossbones"></i> tambah atau edit nama pelaksana gagal <i class="las la-skull-crossbones"></i></button>'
                            );
                            $("#response").fadeTo(5000, 500).slideUp(500, function() {
                                $("#response").slideUp(500);
                            });
        ...
        $('body').on('click', '.deleteProduct', function() {
            var product_id = $(this).data("id");
            var result = confirm("kamu ingin delete nama pelaksana ini !");
            if (result) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('namapelaksana.store') }}" + '/' + product_id,
                    success: function(data) {
                        if (data.success) {
                            $('#response').html(
                                '<button type="button" class="btn mb-3 btn-warning rounded-pill"><i class="las la-exclamation-triangle"></i> nama pelaksana telah dihapus <i class="las la-exclamation-triangle"></i></button>'
                            );
                            $("#response").fadeTo(5000, 500).slideUp(500, function() {
                                $("#response").slideUp(500);
                            });
                            ...
                            $('#response').html(
                                '<button type="button" class="btn mb-3 btn-danger rounded-pill"><i class="las la-skull-crossbones"></i> nama pelaksana gagal dihapus <i class="las la-skull-crossbones"></i></button>'
                            );
                            table.draw();
                        }
                    },
