        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('/nominatif_spj/storeg')}}" method="get" enctype="multipart/form-data"
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            // scrollX: true,
            ajax: "{{ route('nominatif_spj.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        $('body').on('click', '.editProductv', function() {
         ...
         $('body').on('click', '.editProduct_nominatifspj', function() {
            var product_id = $(this).data('id');
            $.get("{{ route('nominatif_spj.index') }}" + '/' + product_id + '/edit', function(data) {
