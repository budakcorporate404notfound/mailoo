...
<nav aria-label="breadcrumb">
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Konsep Surat Tugas</li>
    </ul>
</nav>
@endsection
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body" style="text-align: justify">
                    ...
                    <br> pastikan semua data telah terisi dengan benar
                </div>
    ...
    <div class="modal fade" id="ModalSuccessDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body" style="text-align: justify">
                    <i class="las la-check-circle" style="color: green"></i>
                    <br> data surat tugas berhasil dilakukan penghapusan
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-row">
                            <div class="col" id="nomor_surat_tugas">
                                <label for="nomor_surat_tugas">nomor surat tugas </label>
                                <input id="nomor_surat_tugas" name="nomor_surat_tugas"
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="date" id="tanggal_pelaksana_dari" name="tanggal_pelaksana_dari"
                                    placeholder="tanggal pelaksanaan dari  ..." class="form-control">
                            ...
                            <div class="col">
                                ...
                                <input type="date" id="tanggal_pelaksana_sampai" name="tanggal_pelaksana_sampai"
                                    required="" placeholder="tanggal pelaksanaan sampai ..." class="form-control">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                <label for="nama_pelaksana">nama <span
                                        style="color:red;font-weight:bold">*</span></label>
                                <br>
                                <select id="nama_pelaksana" name="nama_pelaksana">
                                    <option value=""> pilih nama pelaksana ...</option>
                                    @foreach($autofills as $autofill)
                                    <option value="{{ $autofill->nama}}">
                                        {{$autofill->nama}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" id="jabatan" name="jabatan" required required=""
                                    placeholder="jabatan ..." readonly class="form-control" autocomplete="on">
                                @error('jabatan')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('/konsepst/storeg')}}" method="get" enctype="multipart/form-data"
    ...
    <div class="modal fade" id="ajaxModelpdf" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeadingpdf"></h4>
                </div>
                <div class="modal-body">

                    <form action="{{url('/konsepst/storepdf')}}" method="get" enctype="multipart/form-data"
                        class="form-horizontal">

                        <input type="hidden" name="product_id" id="product_idpdf">
                            <button type="submit" class="btn btn-primary" id="saveBtnpdf" value="create">Download</button>
                            <br>
                            <br>
    ...
    $.ajax({
        ...
        success: function(response){
            if(response != null){
                ...
                $('#golongan').val(response.gol);
                $('#jabatan').val(response.jabatan);
                $('#eselon').val(response.eselon);
            }
        }
    });
});
...
<script type="text/javascript">
    $(function() {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        switch (data) {
                            case 0:
                                badge = '<span class="badge badge-danger"  style="width : 100%"; color: red>' +
                                    data + '</span>';
                                break;
                            default:
                                badge = '<span class="badge badge-danger" style="width : 100%" ;color: red>' +
        ...
        $('#createNewProduct').click(function() {
            ...
            $('#modelHeading').html("Tambah Surat Tugas");
            $('#nomor_surat_tugas').hide();
        ...
        $('body').on('click', '.editProduct', function() {
            ...
            $.get("{{ route('realisasirkkl.index') }}" + '/' + product_id + '/edit', function(data) {
                $('#modelHeading').html("Edit Surat Tugas");
                $('#saveBtn').val("edit-user");
                $('#nomor_surat_tugas').show();
        ...
        $('body').on('click', '.editProductx', function() {
            ...
            $.get("{{ route('realisasirkkl.index') }}" + '/' + product_id + '/edit', function(data) {
                ...
                $('#tempat_pelaksana').val(data.tempat_pelaksana);
                 $('#nama_pelaksana_x').val(data.nama_pelaksana_x);
            })
        });
        $('body').on('click', '.editProductg', function() {
            var product_id = $(this).data('id');
            $.get("{{ route('konsepst.index') }}" + '/' + product_id + '/edit', function(data) {
                $('#modelHeadingg').html("Download Sketsa PDF Surat Tugas");
        ...
        $('body').on('click', '.editProductpdf', function() {
            var product_id = $(this).data('id');
            $.get("{{ route('konsepst.index') }}" + '/' + product_id + '/edit', function(data) {
                $('#modelHeadingpdf').html("Download PDF Surat Tugas");
                $('#saveBtnpdf').val("edit-user");
                $('#ajaxModelpdf').modal('show');
                $('#product_idpdf').val(data.id);
                $('#nama_pelaksanapdf').val(data.nama_pelaksana);
                $('#nippdf').val(data.nip);
                $('#golonganpdf').val(data.golongan);
                $('#jabatanpdf').val(data.jabatan);
                $('#tempat_pelaksanapdf').val(data.tempat_pelaksana);
            })
        });
