        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Data Referensi</h4>
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input id="kode_uraian_kegiatan" name="kode_uraian_kegiatan" required=""
                                    placeholder="kode uraian kegiatan ..." class="form-control">
                            ...
                            <div class="col">
                                ...
                                <input id="nama_uraian_kegiatan" name="nama_uraian_kegiatan" required=""
                                    placeholder="nama uraian kegiatan ..." class="form-control">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input id="nama_sub_menu_uraian_kegiatan" name="nama_sub_menu_uraian_kegiatan"
                                    required="" placeholder="sub uraian kegiatan" class="form-control">
                            ...
                            <div class="col">
                                ...
                                <input id="kelompok_pagu" name="kelompok_pagu" required=""
                                    placeholder="kelompok pagu ..." class="form-control">
                                @error('kelompok_pagu')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
                            </div>
                    ...
                    success: function(data) {
                        if (data.success) {
                           ...
                           $('#response').html(
                            ...
                            $('#saveBtn').html('Save Changes');
                           $('#response').html(
                                '<button type="button" class="btn mb-3 btn-danger rounded-pill"><i class="las la-skull-crossbones"></i> tambah atau edit refensi gagal <i class="las la-skull-crossbones"></i></button>'
                            );
                            $("#response").fadeTo(5000, 500).slideUp(500, function() {
                                $("#response").slideUp(500);
                            });
