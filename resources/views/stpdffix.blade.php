...
<body>
    ...
    <div class="row">
        ...
        <div class="column1"
            style=" text-align: center; font-family: Times New Roman; font-size: 16pt">
            <img src="{{ public_path("storage/logo/mahkamahagung.jpg") }}" alt="" style="width: 65px; height: 76px;">
        </div>

        <div class="column2" style=" font-family: Times New Roman; font-size: 16pt">
    ...
    <div class="row">
        <div class="column7" style=" margin-left: auto; margin-right: auto ">
    ...
    <div class="row">
        <div class="column2xx" style="">
            <table style=" border-collapse: collapse; margin-left: auto; margin-right: auto ">
                @foreach ($untukx as $untuk)
                <tbody>
                    <tr>
                        <td
                            style=" width: 100px; border-collapse: collapse; font-size: 12pt; padding: 7px; text-align:top; vertical-align: text-top;">
                            Untuk
                        </td>
                        <td
                            style=" border-collapse: collapse; font-size: 12pt; padding: 7px; text-align:top; vertical-align: text-top; ">
                            :
                        </td>
                        <td
                            style="border-collapse: collapse; font-size: 12pt; padding: 7px; text-align: justify;">
                            {{$untuk->text_untuk}}
                            pada tanggal
        ...
        <div class="column22xx" style="">
            ...
            <table
                ...
                <tbody>
                    ...
                    <tr>
                        <td
                            style=" width: 90%; border-collapse: collapse; font-size: 12pt; padding: 7px;">
