...
<body>
    ...
    <div class="row">
        ...
        <div class="column3x" style="text-align: center; ">
            <b>SURAT TUGAS</b> <br>
    ...
    {{-- UNTUK --}}
    <div class="row">
        <div class="column2xx"  style=" margin-left: auto; margin-right: auto; margin-top: 10px;">
            ...
            <table style=" width:100%; border-collapse: collapse; ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td
                            style=" border-collapse: collapse; font-size: 10.5pt; text-align:top; vertical-align: text-top; ">
                            :
                        </td>
                        <td
                            style=" border-collapse: collapse; font-size: 10.5pt;  text-align: justify;">
                            {{$untuk->text_untuk}}
                        </td>
                    </tr>
    ...
    <div class="container" position="fixed">
        <div class="column22xx" style="margin-left: auto; margin-right: auto; margin-top: 10px">
