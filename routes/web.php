...
use App\Http\Controllers\KeteranganAnggaranController;
use App\Http\Controllers\NominatifSPJ_Controller;
...
Route::group(
    ...
    function () {
        Route::get(
            '/ujicobaslug/{slug}',
            [App\Http\Controllers\ReferensiController::class, 'show']
        )->name('ujicobaslug/{slug}');
        // Route::get('referensi/{slug}', [App\Http\Controllers\ReferensiController::class, 'detail'])->name('referensi/{slug}');
...
Route::group(
    ...
    function () {
        ...
        Route::post('nominatif_spj/storex', [App\Http\Controllers\NominatifSPJ_Controller::class, 'storex'])->name('nominatif_spj.storex');
        Route::get('nominatif_spj/storeg', [App\Http\Controllers\NominatifSPJ_Controller::class, 'storeg'])->name('nominatif_spj.storeg');
        Route::post('nominatif_spj/storez', [App\Http\Controllers\NominatifSPJ_Controller::class, 'storez'])->name('nominatif_spj.storez');
        Route::post('nominatif_spj/storev', [App\Http\Controllers\NominatifSPJ_Controller::class, 'storev'])->name('nominatif_spj.storev');
        Route::resource('nominatif_spj', NominatifSPJ_Controller::class);
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('spj/storeg', [App\Http\Controllers\SPJ_Controller::class, 'storeg'])->name('spj.storeg');
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('rincianpengeluaran/massremove', [App\Http\Controllers\Rincian_PengeluaranController::class, 'massremove'])->name('rincianpengeluaran.massremove');
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('rincianlaporan/massremove', [App\Http\Controllers\Rincian_LaporanController::class, 'massremove'])->name('rincianlaporan.massremove');
        ...
        Route::group(
            ...
            function () {
                Route::get('wilayah/massremove', [App\Http\Controllers\Wilayah_Controller::class, 'massremove'])->name('wilayah.massremove');
                Route::resource('wilayah', Wilayah_Controller::class);
                Route::get('satuankerja/massremove', [App\Http\Controllers\SatuanKerja_Controller::class, 'massremove'])->name('satuankerja.massremove');
                ...
                Route::get('namapelaksana/massremove', [App\Http\Controllers\NamaPelaksana_Controller::class, 'massremove'])->name('namapelaksana.massremove');
        ...
        Route::group(
            ['middleware' => ['role']],
            function () {
                Route::post('ket_anggaran/storex', [App\Http\Controllers\KeteranganAnggaranController::class, 'storex'])->name('ket_anggaran.storex');
                Route::post('ket_anggaran/storey', [App\Http\Controllers\KeteranganAnggaranController::class, 'storey'])->name('ket_anggaran.storey');
                Route::post('ket_anggaran/storez', [App\Http\Controllers\KeteranganAnggaranController::class, 'storez'])->name('ket_anggaran.storez');
                Route::post('ket_anggaran/storev', [App\Http\Controllers\KeteranganAnggaranController::class, 'storev'])->name('ket_anggaran.storev');
                Route::resource('ket_anggaran', KeteranganAnggaranController::class);
            }
        );
